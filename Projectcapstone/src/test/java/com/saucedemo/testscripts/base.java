...
public class base 
{
	...
	driver.findElement(By.id("first-name")).sendKeys("Supreethi");
	driver.findElement(By.id("last-name")).sendKeys("Cherukuri");
	driver.findElement(By.id("postal-code")).sendKeys("500061");
	}
	@Test
